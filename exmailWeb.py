...
if __name__ == '__main__':
    ...
    # 登录页面
    url = r'https://exmail.qq.com/cgi-bin/loginpage'

    # 访问登录页面
    browser.get(url)

    # browser.switch_to_frame('iframe_distributeDomain_proxy_')  # 需先跳转到iframe框架
    ...
    # 输入用户名
    username = browser.find_element_by_id('inputuin')
    print(username)
    username.send_keys('wangxiangui@datahunter.cn')

    # 输入密码
    password = browser.find_element_by_id('pp')
    password.send_keys('887815Zwm')
